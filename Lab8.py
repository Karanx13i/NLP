...
nltk.download('brown')
print("\n")
from nltk.corpus import brown, inaugural # Added inaugural to the import
...
print("\n")
cfd = nltk.ConditionalFreqDist((target, fileid[:4]) for fileid in inaugural.fileids() for w in inaugural.words(fileid) for target in ['president', 'congress']
